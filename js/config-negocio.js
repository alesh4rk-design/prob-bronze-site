...
import { notificarErroFirestore } from "./firestore-erro.js?v=20260727f";
import { INTERVALO_MINIMO_HORAS_PADRAO, LIMITE_SESSOES_MES_PADRAO } from "./ficha-pele.js?v=20260727f";
